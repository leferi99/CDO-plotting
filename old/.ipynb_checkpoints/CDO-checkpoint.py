...
class CustomDREAMOutput:
    ...
    def __init__(self, filename, start_time):
        ...
        if self.hottailgrid_enabled:
            ...
            self.energy_grid_electronvolts = self.momentumgrid * 510998.95
...
# def joined_plot_1D(cdos, key, figsize=None, save=False, yscale=None, markersize=None):
#     """
#     \033[32m
...
#         plt.scatter(timegrid, data_to_plot, s=size)
#         plt.xlabel("time [ms]")
...
#         plt.scatter(cdos[-1].radialgrid, data_to_plot, s=size)
#         plt.xlabel("minor radius [m]")
...
# def joined_plot_1D_HU(cdos, key, figsize=None, save=False, yscale=None, markersize=None, ylabel=None):
#     """
#     \033[32m
#     Hungarian 1D plot of the joined data behind the key. Based on the dimensions 
#     the x-axis is either the time or the radial grid.\033[m
#     """
...
#     axes.set_yscale(yscale)
#     plt.grid()
#     plt.ylabel(ylabel + " [" + cdos[-1].__dict__[key][1] + "]")
